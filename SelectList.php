...
if ($sMode == 'person') {
	// Set the page title
	$sPageTitle = gettext("Lista de Hermanos");
    $iMode = 1;
    ...
    $sPageTitle = gettext("Asignacion de Hermanos a Celulas");
    $iMode = 2;
...
<?= gettext("Orden de clasificación:") ?>
<select name="Sort" onchange="this.form.submit()">
		<option value="name" <?php if ($sSort == "name" || empty($sSort)) echo "selected";?>><?= gettext("Por Nombre") ?></option>
		<option value="family" <?php if ($sSort == "family") echo "selected";?>><?= gettext("Por Familia") ?></option>
		<option value="zip" <?php if ($sSort == "zip") echo "selected";?>><?= gettext("Por CodigoPostal") ?></option>
		<option value="entered" <?php if ($sSort == "entered") echo "selected";?>><?= gettext("Por Nuevos") ?></option>
		<option value="edited" <?php if ($sSort == "edited") echo "selected";?>><?= gettext("Por ultimos cambios") ?></option>
...
<input type="submit" class="btn" value="<?= gettext("Aplicar Filtros") ?>">
...
if (!isset($iGender))
	echo " selected ";
echo '> ' . gettext ("Hombres y Mujeres") . '</option>';

echo '<option value="1"';
if (isset($iGender) && $iGender == 1)
	echo ' selected ';
echo '> ' . gettext ("Hombre") . '</option>';

echo '<option value="2"';
if (isset($iGender) && $iGender == 2)
	echo ' selected ';
echo '> ' . gettext ("Mujer") . '</option></select>';
...
if ($iClassification >= 0)
	echo ' selected ';
echo '>' . gettext("Todas las Clasificaciones") . '</option>';
...
if ($iFamilyRole < 0)
	echo ' selected ';
echo '>' . gettext("Todas los roles de Familia") . '</option>';
...
if ($iMode == 1) {
	...
	if (!isset($iGroupType))
		echo ' selected ';
	echo '>' . gettext("Todas las Celulas") . '</option>';
...
echo '&amp;Sort=name&amp;Filter=' .$sFilter. '">' . gettext("Nombre") . '</a></th>';
...
echo '&amp;Sort=family&amp;Filter=' .$sFilter. '">' . gettext("Familia") . '</a></th>';
...
while ($aRow = mysql_fetch_array($rsPersons)) {
	...
	<?php } else {
		...
		echo gettext("Agregar a Celula") . "</a></td>";
	}
