...
//Set the page title
$sPageTitle = gettext("Vista de Familia");
...
// Format the phone numbers
  ...
  <div class="row">
    <div class="col-lg-3 col-md-4 col-sm-4">
      <div class="box box-primary">
        <div class="box-body">
          ...
          <h3 class="profile-username text-center"><?= gettext("The") . " $fam_Name " . gettext("Familia") ?></h3>
          <?php if ($bOkToEdit) { ?>
    ...
    <div class="col-lg-9 col-md-8 col-sm-8">
      <div class="row">
        <div class="box"><br/>
          <a class="btn btn-app bg-aqua-active" href="FamilyVerify.php?FamilyID=<?= $iFamilyID ?>"><i class="fa fa-check-square"></i> Verificar Información</a>
          <a class="btn btn-app bg-olive" href="PersonEditor.php?FamilyID=<?= $iFamilyID ?>"><i class="fa fa-plus-square"></i> Agregar Nuevo Miembro</a>
          ...
          <?php } ?>
          <a class="btn btn-app btn-danger" role="button" href="FamilyList.php"><i class="fa fa-list-ul"></i> Familia Lista</a>
          <?php if (($next_id > 0)) { ?>
            <a class="btn btn-app" role="button" href="FamilyView.php?FamilyID=<?= $next_id ?>"><i class="fa fa-hand-o-right"></i>Siguiente Familia </a>
          <?php } ?>
          <?php if ($_SESSION['bDeleteRecords']) { ?>
            <a class="btn btn-app bg-maroon" href="SelectDelete.php?FamilyID=<?= $iFamilyID ?>"><i class="fa fa-trash-o"></i> Borrar esta Familia</a>
          <?php } ?>
          <br/>
          <?php if ($bOkToEdit) { ?>
            <a class="btn btn-app" href="#" data-toggle="modal" data-target="#upload-image"><i class="fa fa-camera"></i> <?= gettext("Subir Foto") ?> </a>
            <?php if ($familyService->getUploadedPhoto($iFamilyID) != "") { ?>
              <a class="btn btn-app bg-orange" href="#" data-toggle="modal" data-target="#confirm-delete-image"><i class="fa fa-remove"></i> <?= gettext("Borrar Foto") ?> </a>
            <?php }
          }
          if ($_SESSION['bNotes']) { ?>
            <a class="btn btn-app" href="NoteEditor.php?FamilyID=<?= $iFamilyID ?>"><i class="fa fa-sticky-note"></i> Agregar Nota</a>
          <?php } ?>
          <a class="btn btn-app" href="Reports/ConfirmReport.php?familyId=<?= $iFamilyID ?>"><i class="fa fa-download"></i> Descargar PDF Reporte</a>
          <a class="btn btn-app" href="#" data-toggle="modal" data-target="#confirm-email-pdf"><i class="fa fa-send"></i> Enviar PDF Reporte</a>
          <a class="btn btn-app" href="FamilyView.php?FamilyID=<?= $iFamilyID ?>&AddFamilyToPeopleCart=<?= $iFamilyID ?>"> <i class="fa fa-cart-plus"></i> Agregar los mienbros al Carrito</a>
        </div>
      </div>
    </div>
        ...
        <div class="box box-solid">
          <div class="box-body table-responsive clearfix">
            <table class="table user-list table-hover">
              <thead>
              <tr>
                <th><span>Miembros de Familia</span></th>
                <th class="text-center"><span>Rol</span></th>
                <th><span>Cumpleaños</span></th>
    ...
    <div class="col-lg-12 col-md-6 col-sm-3">
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#timeline" aria-controls="timeline" role="tab" data-toggle="tab"><?= gettext("Linea de Tiempo") ?></a></li>
