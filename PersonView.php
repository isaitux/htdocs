...
<div class="row">
      ...
      <div class="box-body">
        <ul class="fa-ul">
          <li><i class="fa-li fa fa-group"></i><?php echo gettext("Familia:"); ?> <span>
              ...
              <?php } else
                echo gettext("(Ninguna familia asignada)");
              ?>
						</span></li>
          ...
          <?php if ($dBirthDate) { ?>
            <li><i class="fa-li fa fa-calendar"></i><?= gettext("Cumpleaños:") ?> <span><?= $dBirthDate ?></span> (<?php PrintAge($per_BirthMonth, $per_BirthDay, $per_BirthYear, $per_Flags); ?>)</li>
          <?php }
          ...
          <?php }
          if ($sCellPhone) { ?>
            <li><i class="fa-li fa fa-mobile-phone"></i><?= gettext("Celular:") ?> <span><?= $sCellPhone ?></span></li>
          <?php }
          if ($sHomePhone) {
            ?>
            <li><i class="fa-li fa fa-phone"></i><?= gettext("Telefono de Casa:") ?> <span><?= $sHomePhone ?></span></li>
            <?php
          }
          if ($sEmail != "") { ?>
          ...
          if ($sWorkPhone) {
            ?>
            <li><i class="fa-li fa fa-phone"></i><?= gettext("Telefono de trabajo:") ?> <span><?= $sWorkPhone ?></span></li>
          <?php } ?>
  ...
  <div class="col-lg-9 col-md-9 col-sm-9">
    <div class="box box-primary box-body">
      <?php if ($bOkToEdit) { ?>
        <a href="#" class="btn btn-app" data-toggle="modal" data-target="#upload-image"><i class="fa fa-camera"></i><?= gettext("Subir Foto") ?></a>
        ...
        <?php } ?>
      <?php } ?>
      <a class="btn btn-app" href="PrintView.php?PersonID=<?= $per_ID ?>"><i class="fa fa-print"></i> <?= gettext("Imprimir Perfil") ?></a>
      ...
      <?php if ($_SESSION['bNotes']) { ?>
        <a class="btn btn-app" href="WhyCameEditor.php?PersonID=<?php echo $per_ID ?>"><i class="fa fa-question-circle"></i> <?= gettext("Por que vinieron?") ?></a>
        <a class="btn btn-app" href="NoteEditor.php?PersonID=<?php echo $per_ID ?>"><i class="fa fa-sticky-note"></i> <?= gettext("Agregar Nota") ?></a>
      <?php }
      if ($_SESSION['bDeleteRecords']) { ?>
        <a class="btn btn-app bg-maroon" href="SelectDelete.php?mode=person&PersonID=<?= $per_ID ?>"><i class="fa fa-trash-o"></i> <?= gettext("Borrar") ?></a>
      <?php }
      if ($_SESSION['bAdmin']) {
      ...
      <a class="btn btn-app" role="button" href="SelectList.php?mode=person"><i class="fa fa-list"></i> <?= gettext("Lista de Miembros") ?></span></a>
    </div>
  </div>
  <div class="col-lg-9 col-md-9 col-sm-9">
