...
// Set the page title
$sPageTitle = gettext("Bienvenido a <b>Iglesia</b>CRM");
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="<?= $sRootPath ?>/SelectList.php?mode=person" class="small-box-footer">
                <?= gettext("Ver todos los Hermanos") ?> <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="<?= $sRootPath ?>/sundayschool/SundaySchoolDashboard.php" class="small-box-footer">
                <?= gettext("Mas Informacion") ?> <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
    ...
    <div class="col-lg-6">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <h3 class="box-title"><?= gettext("Ultimas Familias") ?></h3>
            </div><!-- /.box-header -->
            <div class="box-body clearfix">
                <div class="table-responsive">
                    <table class="table table-striped table-condensed">
                        <thead>
                        <tr>
                            <th data-field="name"><?= gettext("Familia") ?></th>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th data-field="address"><?= gettext("Dirección") ?></th>
                            <th data-field="city"><?= gettext("Fecha de Cambio") ?></th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        <div class="box box-solid">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= gettext("Ultimos Miembros") ?></h3>
                    <div class="box-tools pull-right">
